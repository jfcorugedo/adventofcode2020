...
test('SAMPLE(part1): given the sample dataset the function works with it', () => {
    expect(repair(sample)).toBe(sampleAnswer);
});

test('REAL(part1): given the real expense report the function can find the two numbers', () => {
